...
if(!getCookie("smart-user")){
    ...
    document.body.innerHTML += `<div class="taskbar">
        <button id="terminal-app" class="system-button">ter</button>
        <button id="open-drawer" class="system-button">ter</button>
        <button id="settings-app" class="system-button">abr</button>
    </div>`;
} else{
    const username = getCookie("smart-user");
    smartUsername = username;
    document.body.innerHTML += `<div class="top-desk">
        <button id="show-menu" class="system-button">test</button>
    </div>`;
    document.querySelector(".top-desk").innerHTML += `<p style='float: right; margin-right: 50%; color: white;'>${username}</p>`;
    ...
    document.body.innerHTML += `<div class="taskbar">
        <button id="terminal-app" class="system-button">tgggg</button>
        <button id="open-drawer" class="system-button">gggg</button>
        <button id="settings-app" class="system-button">ggggggggg</button>
    </div>`;
